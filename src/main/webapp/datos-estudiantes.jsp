                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item">
                                <a href="datos-estudiantes.jsp" class="nav-link active">
            ...
            <div class="content-wrapper" style="min-height: 2646.44px;">
                <section id="about" class="about">
                    <div class="container ">
                        ...
                        <form action="servletEstudiantes"method="POST" class="row g-3">                        
                            <div class="container">
                                <!-- Botón de Guardar con Icono -->
                                <button name="acc" value="guardar"type="submit" class="btn btn-info">
